...
# 需要设置的路径
savepath = "D:/code/coco2017/"  # 保存路径
img_dir = savepath + 'result/bicycle/images_bicycle/'            # 保存图片的文件夹路径
mkr(img_dir)
anno_dir = savepath + 'result/bicycle/annotations_bicycle/'      # 保存xml的文件夹路径
mkr(anno_dir)
...
----|test2017
'''
dataDir = 'D:/code/coco2017/' # coco数据集所在位置
